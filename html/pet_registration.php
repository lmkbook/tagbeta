        ...
        <div id="container">
            ...
            <div id="container2">
                <form method="POST" action="#" id="frm">
                    ...
                    <input type="text" id="names" readonly value="<!-- Valor obtenido del registro de usuario -->"><br>
                    
                    <label for="surname"><strong>Apellido(s) Propietario *</strong></label>
                    <input type="text" id="surname" readonly value="<!-- Valor obtenido del registro de usuario -->"><br>
                    
                    <label for="mail"><strong>Correo Electrónico Propietario *</strong></label>
                    <input type="email" id="mail" readonly value="<!-- Valor obtenido del registro de usuario -->"><br>
                    
                    <label for="ciu"><strong>Ciudad *</strong></label>
                    <input type="text" id="ciu" readonly value="<!-- Valor obtenido del registro de usuario -->"><br>

                    <label for="barrio"><strong>Barrio *</strong></label>
                    <input type="text" id="barrio" placeholder="BARRIO" required maxlength="30" readonly value="<!-- Valor obtenido del registro de usuario -->"><br>
